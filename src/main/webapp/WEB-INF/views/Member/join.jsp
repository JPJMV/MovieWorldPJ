               ...
               <tr class="contentbox">
                  <td class="content">
                     ...
                     <table border="0" cellspacing="0" cellpadding="10">   
                        <form action="joinOk" name="join_frm" method="post">
                           <tr>
                           ...
                           <tr>
                              <td align="right" class="input_text01">비밀번호체크 : </td>
                           ...
                           <tr>
                              <td align="right" class="input_text01">생년월일 : </td>
                              <td><input class="input_box01" type="date" name="mbirth"></td>
                           </tr>
                           <tr>
                              <td align="right" class="input_text01">전화번호 : </td>
                              <td><input class="input_box01" type="text" name="mphone"></td>
                           </tr>
                           <tr>
                              <td colspan="2" align="center">
                                 <input class="button01" type="button" value="가입완료" onclick="joinCheck()">&nbsp;&nbsp;
